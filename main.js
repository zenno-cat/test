                ...
                e.extend({
                    addToCartDefaults: function(t, a) {
                        var o = "@@name@@"
                          ...
                          , r = '<button class="checkout btn btn-success" type="button" onclick="'.concat(s, ';" title="Checkout"><i class="fa fa-lock"></i>Checkout</button>  <div class="cart__advantages" style=" display: flex; flex-direction: column; width: 100%; margin-top: 40px; "> <p class="cart__advantages-item" style=" margin: 0px; "> <i class="fa fa-check"></i> 100% Money Back Quarantee </p> <p class="cart__advantages-item"> <i class="fa fa-check"></i> Free return </p> </div>')
